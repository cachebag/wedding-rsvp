const translations = {
  en: {
    ...
    travelBody: "Plan to arrive December 18 and depart December 20, 2026",
    transportTitle: "Transportation",
    transportBody:
      "Airport transportation to and from Hacienda Cantalagua will be arranged for all guests who book between December 18 to Decmber 20. \
      If you book outside of these dates, you will be repsonsible for arranging your own transportation to and from the hacienda.",
    ...
    mxCeremonyLabel: "Religious Ceremony",
    ...
    mxFaqRoomsItemNames: "Bride & groom names: Sofia Ruiz-Sierra & Akrm Al-Hakimi",
    mxFaqRoomsItemDates: "Wedding weekend dates: December 18–20, 2026",
    ...
    mxFaqRsvpA: "Please RSVP by August 1, 2026.",
  ...
  es: {
    ...
    cocktailTime: "5:00 PM",
    cocktailLabel: "Coctel de bienvenida",
    cocktailDesc:
    ...
    mxFaqRsvpA: "Por favor confirma antes del 1 de agosto de 2026.",
