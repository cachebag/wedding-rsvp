        ...
        <div className="mt-6">
          <div className="border border-amber-200 rounded-md p-6 md:p-8 text-center">
            ...
            <ul className="mt-5 text-base text-stone-800 leading-relaxed space-y-2 text-left list-disc list-inside">
              <li>{locale === "es" ? "Nombres de los novios: Akrm Al-Hakimi y Sofia Ruiz" : "Bride & groom names: Akrm Al-Hakimi & Sofia Ruiz"}</li>
              <li>{locale === "es" ? "Fechas: 17 al 19 de diciembre" : "Wedding weekend dates: December 17–19"}</li>
              <li>{locale === "es" ? "Tu correo electrónico" : "Your email address"}</li>
              <li>
                {locale === "es" ? "Tu habitación preferida — " : "Your preferred room — "}
                <a
                ...
                >
                  {locale === "es" ? "ver opciones aquí" : "browse options here"}
                </a>
              </li>
            </ul>
            <a
            ...
            <p className="mt-2 text-sm text-stone-500 tracking-wide">+52 55 4926 2133</p>
          </div>
        </div>
      </section>
